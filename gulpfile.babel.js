...
export const development = series(cleanFiles, parallel(views, styles, scripts, images, sprites, favs, fonts),
	parallel(watchCode, server));

export const prod = series(cleanFiles, serverConfig, views, styles, scripts, images, sprites, favs, fonts);
